...
router.post('/', isClientOrAdvisor, asyncWrapper(controller.create.bind(controller)));
router.put('/:id', asyncWrapper(controller.update.bind(controller)));
router.patch('/:id/respond', isAdvisor, asyncWrapper(controller.respond.bind(controller)));
router.patch('/:id/link-meeting', isAdvisor, asyncWrapper(controller.linkMeeting.bind(controller)));
